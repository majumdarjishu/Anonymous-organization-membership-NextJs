          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900 tracking-tight">AnonOrg</span>
              </Link>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {!walletAddress ? (
                <button onClick={connectWallet} className="btn-primary flex items-center space-x-2 py-1.5 px-3 text-sm">
                  <Wallet className="h-4 w-4" />
                  <span>Connect Lace</span>
                </button>
              ) : (
                <button onClick={disconnectWallet} className="btn-secondary flex items-center space-x-2 py-1.5 px-3 text-sm">
                  <Wallet className="h-4 w-4 text-primary-600" />
                  <span className="truncate max-w-[100px]">{walletAddress.slice(0, 8)}...</span>
                </button>
              )}
            </div>
